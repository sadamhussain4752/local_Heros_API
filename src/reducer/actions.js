...
export const BANNER_STORE_REQUEST = 'BANNER_STORE_REQUEST';
export const BANNER_STORE_SUCCESS = 'BANNER_STORE_SUCCESS';
export const BANNER_STORE_FAILURE = 'BANNER_STORE_FAILURE';
export const FAQ_STORE_REQUEST = 'FAQ_STORE_REQUEST';
export const FAQ_STORE_SUCCESS = 'FAQ_STORE_SUCCESS';
export const FAQ_STORE_FAILURE = 'FAQ_STORE_FAILURE';
...
export const BannerRequestRequest = () => ({
  type: BANNER_STORE_REQUEST,
});

export const BannerRequestSuccess = (data) => ({
  type: BANNER_STORE_SUCCESS,
  payload: data,
});

export const BannerRequestFailure = (error) => ({
  type: BANNER_STORE_FAILURE,
  payload: error,
});

export const FAQRequest = () => ({
  type: FAQ_STORE_REQUEST,
});

export const FAQRequestSuccess = (data) => ({
  type: FAQ_STORE_SUCCESS,
  payload: data,
});

export const FAQRequestFailure = (error) => ({
  type: FAQ_STORE_FAILURE,
  payload: error,
});
